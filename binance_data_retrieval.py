...
def minutes_of_new_data(symbol, kline_size, data, source):
    if len(data) > 0:
        ...
        old = datetime.strptime('1 Jan 2018', '%d %b %Y')
...
def get_all_binance(symbol, kline_size, save=False):
    filename='/Users/shankarsathishchandran/Desktop/Projects/Python/Binance KLines Retrieval/data/%s-%s-data.csv' % (symbol, kline_size)
    ...
    if oldest_point == datetime.strptime('1 Jan 2017', '%d %b %Y'):
        ...
        print('Download %d minutes of new data available for %s, i.e. %d instances of %s data.' 
